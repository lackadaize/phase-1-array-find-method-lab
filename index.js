...
console.log("The Denver Broncos last won the Superbowl in " + superbowlWin(record) + ".");
console.log("The Denver Broncos last won the Superbowl in " + superbowlWin(sadRealtiy) + ".");
